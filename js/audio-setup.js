...
// function createAudioProcessor(audioContext, mediaStreamSource) {
//     let processor = audioContext.createScript
// }

function createAudioProcessor(audioContext, audioSource) {
    let processor = audioContext.createScriptProcessor(4069, 1, 1);
